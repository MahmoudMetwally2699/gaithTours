...
export const en = {
    ...
    hotels: {
        ...
        expectedPriceDescription: 'Expected price per night in USD',
    ...
    profile: {
        ...
        invoicesWillAppear: 'Your invoices will appear here when available',
        ...
        created: 'Created',
        payNow: 'Pay Now',
        processing: 'Processing...', viewInvoice: 'View Invoice',
        paymentStatusValues: {
            paid: 'Paid',
            unpaid: 'Unpaid',
            pending: 'Pending',
        ...
        paidOn: 'Paid On', paymentComplete: 'Payment Complete',
        paymentMethod: 'Payment Method',
    ...
    payment: {
        ...
        failure: {
            ...
            note: 'No charges have been made to your account. You can retry the payment from your invoices.'
        },
        error: {
            processing: 'Error processing payment confirmation',
