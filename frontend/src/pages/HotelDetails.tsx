     ...
     return (
       <div className="min-h-screen bg-white">
         ...
         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-4 md:mt-8">
           {/* Skeleton Title */}
           <div className="mb-6">
             <div className="h-8 bg-gray-200 rounded-lg w-3/4 max-w-[18rem] mb-2 animate-pulse" />
             <div className="h-4 bg-gray-200 rounded w-full max-w-[24rem] mb-3 animate-pulse" />
           ...
           <div className="mb-10">
             <div className="h-7 bg-gray-200 rounded w-3/5 max-w-[14rem] mb-4 animate-pulse" />
           ...
           {/* Skeleton Rooms */}
           <div className="mb-12">
             <div className="h-7 bg-gray-200 rounded w-2/5 max-w-[12rem] mb-6 animate-pulse" />
             {[1,2,3].map(i => (
           ...
           <div className="flex-1">
              ...
              <div className="flex items-center gap-4">
                 ...
                 {(() => {
                   ...
                   const ratingValue = taRating ? taRating * 2 : (hotel.reviewScore || hotel.rating || 0);
